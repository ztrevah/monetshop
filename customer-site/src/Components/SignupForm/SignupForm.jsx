...
const Step1 = () => {
    ...
    const handleSubmit = async e => {
        ...
        if(inputs.email.length === 0) setError("Required");
            ...
            try{
                const res = await axios.post("https://monetshop.onrender.com/api/auth/signups1",inputs,{withCredentials: true});
                console.log(res);
...
const Step2 = (props) => {
    ...
    useEffect(() => {
        if(email === null) {
            ...
            const checkEmail = async () => {
                try{
                    const res = await axios.post("https://monetshop.onrender.com/api/auth/checkmailsignup",{email: email},{withCredentials: true});
    ...
    const handleSubmit = async e => {
        ...
        if(!(input.email) || !(input.password) || !(input.firstname) || !(input.phone) || !(input.code)) {
            ...
            try{
                const res = await axios.post("https://monetshop.onrender.com/api/auth/signups2",input,{withCredentials: true});
                console.log(res);
    ...
    const resendCode = () => {
        try{
            const res = axios.post("https://monetshop.onrender.com/api/auth/signups1",input,{withCredentials: true});
            console.log(res);
        } catch(err) {
            console.log(err);
            setRequestError(err.response.data);
