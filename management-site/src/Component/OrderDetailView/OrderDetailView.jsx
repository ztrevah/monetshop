...
const OrderInfoDiv = (props) => {
    ...
    useEffect(() => {
        const getorderinfo = async () => {
            try {
                const res = await axios.post("https://monetshop.onrender.com/api/management/orderinfo",props,{withCredentials: true});
...
const OrderItemsDiv = (props) => {
    ...
    useEffect(() => {
        const getorderitems = async () => {
            try {
                const res = await axios.post("https://monetshop.onrender.com/api/management/orderitems",props,{withCredentials: true});
...
const OrderHistoryDiv = (props) => {
    ...
    useEffect(() => {
        const getOrderHistory = async () => {
            try {
                const res = await axios.post("https://monetshop.onrender.com/api/management/orderhistory",props,{withCredentials: true});
